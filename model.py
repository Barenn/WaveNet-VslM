...
"""
Implementation de WaveNEt - ENSAI 2020
...
def WaveNetResidualConv1D(num_filters, kernel_size, dilation_rate):
    ...
    Args:
        ...
        dilation_rate (int): The dilation rate for the dilated
        convolution.
    Returns:
...
def build_wavenet_model(input_size, num_filters, kernel_size,
    ...
    Args:
        ...
        num_residual_blocks (int): How many residual blocks to generate
            between input and output. Residual block i will have a
            dilation rate of 2^(i+1), i starting from zero.
    Returns:
    ...
    l_stack_conv1d = Conv1D(
        num_filters, kernel_size, padding="same")(l_input)
    l_skip_connections = []
